...
fn main() {
    ...
    println!("19:1: {}", solve_timed(day19::star_one));
    println!("19:2: {}", solve_timed(day19::star_two));
    println!("20:1: {}", solve_timed(day20::star_one));
    println!("20:2: {}", solve_timed(day20::star_two));
    println!("21:1: {}", solve_timed(day21::star_one));
    println!("21:2: {}", solve_timed(day21::star_two));
    println!("22:1: {}", solve_timed(day22::star_one));
    println!("22:2: {}", solve_timed(day22::star_two));
    println!("23:1: {}", solve_timed(day23::star_one));
    println!("23:2: {}", solve_timed(day23::star_two));
    println!("24:1: {}", solve_timed(day24::star_one));
    println!("24:2: {}", solve_timed(day24::star_two));
    println!("25:1: {}", solve_timed(day25::star_one));
}
